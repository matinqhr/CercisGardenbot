...
export const QUESTION_BANK: Question[] = [
  { id: 'plants-001', text: 'Which part of a plant usually absorbs water and minerals from the soil?', options: ['Leaf', 'Root', 'Flower'], correctAnswers: [1], xp: 10, difficulty: 'easy' },
  { id: 'plants-002', text: 'Which process allows green plants to make food using light?', options: ['Photosynthesis', 'Respiration', 'Germination'], correctAnswers: [0], xp: 10, difficulty: 'easy' },
  { id: 'plants-003', text: 'Which of these is a part of a typical flower?', options: ['Petal', 'Stamen', 'Root'], correctAnswers: [0, 1], xp: 15, difficulty: 'medium' },
  { id: 'plants-004', text: 'Which statement about roots is correct?', options: ['They can anchor a plant', 'They always grow above the soil', 'They can absorb water'], correctAnswers: [0, 2], xp: 15, difficulty: 'medium' },
